...
import static com.mall.common.constant.AuthServerConstant.LOGIN_USER;
...
public class LoginController {
    ...
    public String register(UserRegisterVo vos, RedirectAttributes attributes) {
        ...
        //获取存入Redis里的验证码       之后再改过来！！！zjy
        //String redisCode = stringRedisTemplate.opsForValue().get(AuthServerConstant.SMS_CODE_CACHE_PREFIX + vos.getPhone());
        String redisCode = "1111";
        if (!StringUtils.isEmpty(redisCode)) {
            //截取字符串
            if (code.equals(redisCode.split("_")[0])) {
                //删除验证码;令牌机制       之后再改过来！！！zjy
