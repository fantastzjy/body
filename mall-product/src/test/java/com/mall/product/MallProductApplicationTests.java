...
//        String accessKeyId = "LTAI5tGFM1cGP2afwpQFfnyL";
//        String accessKeySecret = "QLcPP7HaQkvJCeYdSkSLy7Vq2aD0AN";
//
//        // 创建OSSClient实例。
//        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
//
//        // 上传文件流。
//        InputStream inputStream = new FileInputStream("C:\\大型电商--谷粒商城\\1.分布式基础（全栈开发篇）\\资料源码下载地址.txt");
//
//        ossClient.putObject("gulimall-fantastzjy", "地址.txt", inputStream);
//
//        // 关闭OSSClient。
//        ossClient.shutdown();
//
