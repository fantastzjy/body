...
@RunWith(SpringRunner.class)//指定使用spring的驱动来跑单元测试，引入该注解才可以使用sppringboot 的环境  才可以注入 实例 @Autowired
@SpringBootTest
public class MallSearchApplicationTests {
    ...
    public void indexData() throws IOException {
        ...
        indexRequest.source(jsonString, XContentType.JSON);  //要保存的内容，，必须要设置数据类型
