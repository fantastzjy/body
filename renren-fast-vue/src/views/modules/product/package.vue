  ...
  <div class="mod-config">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('product:cpackage:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('product:cpackage:delete')" type="danger" @click="deleteHandle()"
                   :disabled="packageListSelections.length <= 0">批量删除
        </el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="180" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addProject(scope.row)">添加项目</el-button>
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.packageId)">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.packageId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!--新增关联-->
    <el-dialog title="关联项目" :visible.sync="packageProjectRelationDialogVisible" width="40%">
      ...
      <el-table :data="projectRelationTableData" style="width: 100%">
        ...
        <el-table-column fixed="right" header-align="center" align="center" label="操作">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="deleteCateRelationHandle(scope.row.id, scope.row.projectId)">移除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
