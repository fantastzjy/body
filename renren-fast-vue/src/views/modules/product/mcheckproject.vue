  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <!--        <el-button v-if="isAuth('product:mcheckproject:save')" type="primary" @click="addOrUpdateHandle()">新增-->
        <!--        </el-button>-->
        <!--        <el-button v-if="isAuth('product:mcheckproject:delete')" type="danger" @click="deleteHandle()"-->
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column prop="projectName" header-align="center" align="center" label="项目名称">
      </el-table-column>
      ...
      <el-table-column prop="isException" header-align="center" align="center" label="是否异常">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.isException === 1 ? "是" : "否" }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="isValid" header-align="center" align="center" label="是否有效">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.isValid === 1 ? "是" : "否" }}</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="120" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">录入检查结果</el-button>
...
<script>
import AddOrUpdate from './mcheckproject-add-or-update'
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/product/checkproject/list'),
        method: 'get',
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/product/checkproject/delete'),
          method: 'post',
