  ...
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="用户昵称" prop="memberName">
        <el-input v-model="dataForm.memberName" placeholder="用户昵称"></el-input>
      </el-form-item>
      ...
      <el-form-item label="已体检项目" prop="checkedIds">
        <el-input v-model="dataForm.checkedIds" placeholder="已体检项目"></el-input>
      </el-form-item>
      <el-form-item label="体检状态" prop="status">
        <el-input v-model="dataForm.status" placeholder="体检状态"></el-input>
      </el-form-item>
      <el-form-item label="异常项目" prop="exceptionIds">
        <el-input v-model="dataForm.exceptionIds" placeholder="异常项目"></el-input>
      </el-form-item>
      <el-form-item label="体检报告" prop="report">
        <el-input v-model="dataForm.report" placeholder="体检报告"></el-input>
      </el-form-item>
      <el-form-item label="体检报告出具医生" prop="reportBy">
